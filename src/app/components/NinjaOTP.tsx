...
import NinjaOTPQueue from '@/app/lib/NinjaOtpQueue';
...
export default function NinjaOTP() {
    ...
    const startFetching = () => {
        ...
        setIsRunning(true);
        setLogs([{ text: 'Starting NinjaOTP service...', type: 'info' }]);

        queueRef.current = new NinjaOTPQueue(
            handleLog,
            () => setIsRunning(false)
        );
    ...
    return (
        <div className="p-4 border rounded-lg bg-white dark:bg-gray-800 shadow-md">
            <h2 className="text-xl font-semibold mb-4 dark:text-white">NinjaOTP</h2>
            ...
            <div className="space-y-4">
                <div>
                    ...
                    <input
                        ...
                        placeholder="Enter NinjaOTP API key"
                    />
                </div>
