...
export default async function fetchNumberDetails(phoneNumber: string) {
    try {
        ...
        // console.log('Initial Cookies:', initialCookies); // uncomment for debugging if needed
        // console.log('---------------------------------------'); // uncomment for debugging if needed
        ...
        // console.log('Combined Cookies:', combinedCookies); // uncomment for debugging if needed
        // console.log('---------------------------------------'); // uncomment for debugging if needed
        // console.log('CSRF Token:', csrfToken); // uncomment for debugging if needed
        // console.log('---------------------------------------'); // uncomment for debugging if needed

        console.log(`Fetching number details for ${phoneNumber}...`);
        console.log('---------------------------------------');
        const numberDetails = await signinWithCheck(agent, combinedCookies, csrfToken, phoneNumber);
        if (!numberDetails) {
            throw new Error('Failed to fetch number details.');
        }
        // console.log('Numbder details: ', numberDetails); // uncomment for debugging if needed
        // console.log('---------------------------------------'); // uncomment for debugging if needed
